...
class Cluster(object):
    ...
    def computeCentroid(self):
        ...
        '''
        # f = []
        # Centroid = sample.Sample('Centroid', f)
        # d = self.samples[0].dimensionality()
        # for i in self.samples:
        #     Centroid.features += i.getFeatures()
        # Centroid = Centroid / len(self.samples)
        #
        # return Centroid
    ...
    def update(self, new_samples):
        ...
        # new_Centroid = self.samples.computeCentroid()
        # d = original_Centroid.distance(new_Centroid)
        # return d
